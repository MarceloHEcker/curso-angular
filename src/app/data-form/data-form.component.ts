...
export class DataFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formulario.get( 'endereco.cep' ).statusChanges.pipe(
      ...
      switchMap( status => status === 'VALID' ? this.cepService.consultaCEP( this.formulario.get( 'endereco.cep' ).value ) : empty() ) ).subscribe( dados => dados ? this.populaDadosForm( dados ) : {} );
